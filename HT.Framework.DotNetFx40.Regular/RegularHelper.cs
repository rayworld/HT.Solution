...
namespace HT.Framework.DotNetFx40.Regular
{
    /// <summary>
    /// 正则表达式助手
    /// </summary>
    public static class RegularHelper
    {
        ...
        {
            Regex regex = new Regex(@"^(0|86|17951)?(13[0-9]|15[012356789]|18[0-9]|14[57]|17[678])[0-9]{8}$");
        ...
        public static bool IsChinaMobilePhone(string value)
        {
             ...
             */
            Regex regex = new Regex(@"(^1(3[4-9]|4[7]|5[0-27-9]|7[8]|8[2-478])\d{8}$)|(^1705\d{7}$)");
            return regex.IsMatch(value);
        }
        ...
        public static bool IsChinaUnicomPhone(string value)
        {
             ...
             */
            Regex regex = new Regex(@"(^1(3[0-2]|4[5]|5[56]|7[6]|8[56])\d{8}$)|(^1709\d{7}$)");
            return regex.IsMatch(value);
        }
        ...
        public static bool IsChinaTelecomPhone(string value)
        {
             ...
             */
            Regex regex = new Regex(@"(^1(33|53|77|8[019])\d{8}$)|(^1700\d{7}$)");
            return regex.IsMatch(value);
        }
        ...
        public static bool IsIdCard(string value)
        {
            ...
            {
                Regex regex = new Regex(@"^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[Xx])$",
        ...
        {
            Regex regex = new Regex(@"[A-F0-9]{8}(-[A-F0-9]{4}){3}-[A-F0-9]{12}|[A-F0-9]{32}", RegexOptions.IgnoreCase);
        ...
        {
            Regex regex = new Regex(@"^(http|https)\://([a-zA-Z0-9\.\-]+(\:[a-zA-Z0-9\.&%\$\-]+)*@)*((25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9])\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[1-9]|0)\.(25[0-5]|2[0-4][0-9]|[0-1]{1}[0-9]{2}|[1-9]{1}[0-9]{1}|[0-9])|localhost|([a-zA-Z0-9\-]+\.)*[a-zA-Z0-9\-]+\.(com|edu|gov|int|mil|net|org|biz|arpa|info|name|pro|aero|coop|museum|[a-zA-Z]{1,10}))(\:[0-9]+)*(/($|[a-zA-Z0-9\.\,\?\'\\\+&%\$#\=~_\-]+))*$",
                    RegexOptions.IgnoreCase);
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^([0-9A-F]{2}-){5}[0-9A-F]{2}$");

            Regex regex1 = new Regex(@"^[0-9A-F]{12}$");


            return regex.IsMatch(value) || regex1.IsMatch(value);
        }
        ...
        public static bool IsVersion(string value, int length = 5)
        {
            ...
            Regex regex = new Regex(string.Format(@"^{0}{1}{2}$", @"\d{0,4}\.(\d{1,4}\.){0,", length, @"}\d{1,4}"));
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^http(s)?\://((www.)?[a-zA-Z0-9\-]+\.(com|edu|gov|int|mil|net|org|biz|arpa|info|name|pro|aero|coop|museum|[a-zA-Z]{1,10}))(\:[0-9]+)*(/($|[a-zA-Z0-9\.\,\?\'\\\+&%\$#\=~_\-]+))*$");
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^[1-9]\d{5}$", RegexOptions.IgnoreCase);
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"[\w\d_]+", RegexOptions.IgnoreCase);
            return regex.IsMatch(value);
        }
        ...
        public static bool IsPostfix(string value, string[] postfixs)
        {
            ...
            Regex regex = new Regex($@".(?i:{postfix})$");
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^([0-9])[0-9]*(\.\w*)?$");
            return regex.IsMatch(value);
        }
        ...
        public static bool IsBase64(string value)
        {
            ...
            return value.Length % 4 == 0 && regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^[1-9][0-9]{4,9}$");
            return regex.IsMatch(value);
        }
        ...
        public static bool IsDate(string value, bool isRegex = false)
        {
            ...
            return DateTime.TryParse(value, out DateTime minValue);
        }
        ...
        {
            return DateTime.TryParseExact(value, format, provider, styles, out DateTime minValue);
        }
        ...
        {
            if (!DateTime.TryParse(value, out DateTime dateTime)) return false;
        ...
        public static bool IsDouble(string value, double minValue, double maxValue, int digit)
        {
            ...
            if (digit > 0)
                patten = $@"^\d[.]?\d{"{" + digit + "}"}$";
            if (!Regex.IsMatch(value,patten)) return false;
        ...
        {
            Regex regex = new Regex(@"^[\@A-Za-z0-9\!\#\$\%\^\&\*\.\~_]{6,25}$");
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex($@"^[\@A-Za-z0-9\!\#\$\%\^\&\*\.\~_]{"{" + min},{max + "}"}$");
            return regex.IsMatch(value);
        }
        ...
        {
            Regex regex = new Regex(@"^(?![^a-zA-Z]+$)[A-Za-z0-9]{6,30}$");
            return regex.IsMatch(value);
        }
        ...
        {
            return Regex.IsMatch(value,$@"^(?![^a-zA-Z]+$)[A-Za-z0-9]{"{" + min},{max + "}"}$");
        }
